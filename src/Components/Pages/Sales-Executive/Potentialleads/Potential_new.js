...
const Potentialleads = () => {
  ...
  // Static dropdown options for filtering and in-table update
  ...
  // ----------------------------
  // In-table status change handlers
  // ----------------------------
      ...
      <div className={`salesOpportunity ${collapsed ? "collapsed" : ""}`}>
        <div className="potentialleads-table-container">
          ...
          <Row className="mb-3">
            ...
            <Col md={3}>
              {/* Use static primary options from dropdownOptions */}
              <select
                className="form-select"
            ...
            <Col md={3}>
              {/* Use computed static options for Opportunity Status2 */}
              <select
                className="form-select"
